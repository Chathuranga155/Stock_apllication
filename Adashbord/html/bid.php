            ...
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        ...
                        <a href="../html/stock/active_inactive/index.php" class="dash-nav-dropdown-item">All Auction List</a>
                ...
                <div class="dash-nav-dropdown ">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        ...
                        <a href="../html/stock/stockdetails.php" class="dash-nav-dropdown-item">All Stock</a>
...
<main class="my-5">
    <?php include "../html/bid_col.php"; ?>
<?php include "../html/a.php";?>
</main>
