        ...
        <div class="dash-nav dash-nav-dark">
            ...
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown ">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        <a href="cards.html" class="dash-nav-dropdown-item">ADD Stock</a>
                        <a href="forms.html" class="dash-nav-dropdown-item">All Stock</a>
...
<main><br>
    <?php  include "../html/stock/active_inactive/index.php";?>
</main>
